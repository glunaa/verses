...
const App: FC = () => {
  const prayers: verseProps[] = [
    ...
    },
    {
      ...
      latinBody: 'Pater Noster, qui es in caelis, sanctificetur Nomen Tuum. Adveniat Regnum Tuum. Fiat voluntas Tua, sicut in caelo, et in terra. Panem nostrum quotidianum da nobis hodie. Et dimitte nobis debita nostra sicut et nos dimittimus debitoribus nostris. Et ne nos inducas in tentationem, sed libera nos a malo. Amen.',
    },
    {
      title: 'Hail Mary',
      ...
      latinBody: 'Ave Maria, gratia plena, Dominus tecum; benedicta tu in mulieribus, et benedictus fructus ventris tui, Iesus. Sancta Maria, Mater Dei, ora pro nobis peccatoribus, nunc et in hora mortis nostrae. Amen.',
    },
    {
      title: 'Glory Be',
      ...
      latinBody: 'Gloria Patri, et Filio, et Spiritui Sancto. Sicut erat in principio, et nunc, et semper, et in saecula saeculorum. Amen.',
    },
    {
      title: 'Fatima Prayer',
      ...
      latinBody: 'O Iesu, dimitte nobis peccata nostra, salva nos ab igne inferni, ducis omnes animas ad caelum, praesertim eas quae misericordia Tua maxime indigent.',
    },
    {
      ...
      latinBody: 'O Deus meus, ex toto corde paenitet me omnium meorum peccatorum, quia peccando Te offendi, qui es omnia bona et dignus omni mea caritate. Firmiter propono, adiuvante gratia Tua, confiteri peccata mea, poenitere, et vitam meam emendare. Amen.',
    },
    {
      title: 'Anima Christi',
      ...
      latinBody: 'Anima Christi, sanctifica me. Corpus Christi, salva me. Sanguis Christi, inebria me. Aqua lateris Christi, lava me. Passio Christi, conforta me. O bone Iesu, exaudi me. Intra vulnera tua absconde me. Ne quando separeris a me. Ab hoste maligno protege me. In hora mortis meae voca me, et iube me venire ad Te, ut cum sanctis tuis laudem Te in saecula. Amen.',
    },
    {
      ...
      latinBody: 'Credo in Deum Patrem omnipotentem, Creatorem caeli et terrae; et in Iesum Christum, Filium eius unicum, Dominum nostrum, qui conceptus est de Spiritu Sancto, natus ex Maria Virgine, passus sub Pontio Pilato, crucifixus, mortuus, et sepultus; descendit ad inferos; tertia die resurrexit a mortuis; ascendit ad caelos, sedet ad dexteram Dei Patris omnipotentis; inde venturus est iudicare vivos et mortuos. Credo in Spiritum Sanctum, sanctam Ecclesiam catholicam, communionem sanctorum, remissionem peccatorum, carnis resurrectionem, vitam aeternam. Amen.',
    },
    {
      ...
      latinBody: 'Angelus Domini, custos meus, cui me commissit divina providentia, praesens esto semper ad me, ut me luceas, custodi, rege, et gubernes. Amen.',
    },
    {
      title: 'Jesus Prayer',
    ...
    },
    {
      ...
      latinBody: 'Sancte Michael Archangele, defende nos in proelio. Contra nequitiam et insidias diaboli esto praesidium. Deus, humiliter rogamus, repelle eum; et tu, Princeps Exercitus Caelestis, per Divinam Potentiam Dei, mitte in infernum Satanam et omnes spiritus malignos qui per orbem terrarum animas perditionem quaerunt. Amen.',
    },
    {
    ...
    },
    {
      ...
      latinBody: 'Pater aeternus, offero Tibi pretiosissimum sanguinem Filii Tui Divini Iesu, in unione cum Missis celebratis hodie per orbem terrarum, pro omnibus animabus sanctis in Purgatorio. Amen.',
    },
    {
    ...
    ,latinBody: 'O Iesu, amor meus, desiderium meum unicum, dulcis delectatio mea, totus tibi me do. Accipe me, posside me, et fac mecum quod vis. Totus tuus esse volo et omnia facere propter amorem Tuum. Sufferre et mori volo propter amorem Tuum. Fac me esse victima amoris Tui. Amen.',
    },
    {
    ...
    <div className="parent">
      ...
      <div className="container">
        ...
        <div className="buttons">
          ...
          <button onClick={handleRandom}>Random Prayer</button>
